...
namespace MVC.Controllers
{
    public class EvaluationsController : MvcController
    {
        ...
        protected void SetViewData()
        {
            ...
            ViewBag.EvaluatedIds = new MultiSelectList(_evaluatedService.Query().ToList(), "Record.Id", "FullName");
        ...
        public IActionResult Create(EvaluationModel evaluation, int[] evaluatedIds)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    foreach (var evaluatedId in evaluatedIds)
                    {
                        var evaluatedEvaluation = new EvaluatedEvaluation
                        {
                            EvaluationId = evaluation.Record.Id,
                            EvaluatedId = evaluatedId
                        };
                        // Save evaluatedEvaluation to the database
                    }
